...
import { BarChart3, ClipboardList, MapPin, Users, TrendingUp, Calendar, Upload, LogOut, Activity, Filter } from 'lucide-react'
...
type TabType = 'overview' | 'tickets' | 'heatmap' | 'analytics'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl">Authority Dashboard</h1>
              <p className="text-sm text-muted-foreground">
                Welcome, {user?.user_metadata?.name || 'Authority'}
              </p>
            </div>
            <div className="flex items-center space-x-2">
              <NotificationCenter userRole="authority" userId={user?.id} />
