      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center">
            ...
            Raise New Issue - Step {step} of 3
          </CardTitle>
                  ...
                  <CardContent className="p-4">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <p>{ticketData.location.address}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p>{ticketData.location.digiPin}</p>
                      </div>
                      <div>
                        <p className="text-muted-foreground">Coordinates</p>
                        <p>{ticketData.location.lat.toFixed(4)}, {ticketData.location.lng.toFixed(4)}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
